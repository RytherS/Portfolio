...
import { ROUTER_FEATURE_KEY, RouterState } from './router-state.state';

export const selectRouterStateFeature =
...
export const selectRouteRoot = createSelector(selectUrl, (url: string) => {
